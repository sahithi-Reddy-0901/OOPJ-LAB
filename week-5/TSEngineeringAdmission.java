...
class TSEngineeringAdmission
{
	public static void main(String[] args)
	{
		try
		{
			 ...
			 if (score < 50) {
                throw new NotEligibleForEngineering("Not Eligible for Engineering Admission. Score < 50");
            } 
            else if (score < 70) {
                throw new NotEligibleForVJIT("Eligible for Engineering but Not Eligible for VJIT (Score < 70)");
            } 
            else {
